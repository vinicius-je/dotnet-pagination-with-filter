...
BEGIN
	...
	VALUES 
		-- Eletrônicos (1)
		(NEWID(), 'Laptop Dell XPS 13', 'Ultrabook com processador Intel i7 e SSD de 512GB', 8999.99, 1, 10),
		(NEWID(), 'Smartphone Samsung Galaxy S23', 'Celular Android com câmera de 50MP', 5999.90, 1, 25),
		(NEWID(), 'Monitor LG Ultrawide 29"', 'Monitor IPS com resolução 2560x1080', 1599.90, 1, 12),
		...
		-- Roupas (2)
		(NEWID(), 'Camiseta Nike Dry Fit', 'Camiseta esportiva de tecido tecnológico', 129.90, 2, 50),
		(NEWID(), 'Jaqueta de Couro Preta', 'Jaqueta de couro legítimo, estilo clássico', 799.90, 2, 15),
		...
		-- Comida (3)
		(NEWID(), 'Chocolate Lindt 70%', 'Chocolate amargo premium, barra de 100g', 29.90, 3, 100),
		...
		-- Móveis (4)
		(NEWID(), 'Cadeira de Escritório Ergonômica', 'Cadeira ajustável com apoio lombar', 1299.90, 4, 8),
		...
		-- Livros (5)
		(NEWID(), 'Livro Clean Code', 'Livro sobre boas práticas de programação', 199.90, 5, 30),
		...
		-- Brinquedos (6)
		(NEWID(), 'LEGO Star Wars Millennium Falcon', 'Modelo colecionável da Millennium Falcon', 1499.90, 6, 5),
		...
		-- Beleza (7)
		(NEWID(), 'Perfume Chanel No. 5', 'Fragrância feminina icônica', 999.90, 7, 20),
		...
		-- Esportes (8)
		(NEWID(), 'Bola de Futebol Adidas', 'Bola oficial da Copa do Mundo', 149.90, 8, 40),
		...
		-- Automotivo (9)
		(NEWID(), 'Óleo Sintético Mobil 1 5W30', 'Óleo sintético para motor de alto desempenho', 89.90, 9, 60),
		...
		-- Saúde (10)
		(NEWID(), 'Kit de Suplementos Whey Protein', 'Whey Protein + BCAA + Creatina', 299.90, 10, 25),
